...
//    public static final RegistryObject<Item> COOKED_CHICKEN_NUGGET = ITEMS.register("cooked_chicken_nugget", () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(3).saturation(1.4F).build())));
    ...
    public static final RegistryObject<Item> CHEESE_FRIES = ITEMS.register("cheese_fries", () -> new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(8).saturation(6.5F).build())));
    public static final RegistryObject<Item> POTATO_SKINS = ITEMS.register("potato_skins", () -> new HarvestcraftItem(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(6).saturation(7.5F).build())));
