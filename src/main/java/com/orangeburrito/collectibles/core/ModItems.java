...
public class ModItems {
    ...
    public static final RegistryObject<Item> CHEESE_PUFFS = ITEMS.register("cheese_puffs", () -> new HarvestcraftItem(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(6).saturation(0.6F).build())));
