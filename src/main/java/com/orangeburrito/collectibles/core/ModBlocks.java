...
import com.orangeburrito.collectibles.blocks.*;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> LAPTOP = BLOCKS.register("laptop", () -> new Laptop(Block.Properties.from(GAMECUBE.get())));
    public static final RegistryObject<Block> PLAYSTATION = BLOCKS.register("playstation", () -> new Playstation(Block.Properties.from(GAMECUBE.get())));
