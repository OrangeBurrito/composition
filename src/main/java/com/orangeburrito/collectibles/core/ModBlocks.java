...
//    public static final RegistryObject<Block> TABLE = BLOCKS.register("table", () -> new Table(Block.Properties.create(Material.WOOD).hardnessAndResistance(2, 3).harvestLevel(0).harvestTool(ToolType.AXE).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<Block> TERRARIUM = BLOCKS.register("terrarium", () -> new TerrariumBlock(Block.Properties.create(Material.GLASS).hardnessAndResistance(0.8F, 0.8F).sound(SoundType.GLASS).harvestTool(ToolType.PICKAXE).harvestLevel(0)));
