...
public class SofaBlock extends WaterloggedHorizontalBlock {
    ...
    private ImmutableMap<BlockState, VoxelShape> generateShapes(ImmutableList<BlockState> states) {
        final VoxelShape[] SEAT = VoxelHelper.getRotatedShapes(VoxelHelper.rotate(Block.makeCuboidShape(1, 2.5, -2.5, 15, 8, 13), Direction.NORTH));
        ...
        final VoxelShape[] BACK_LEFT_LEG = VoxelHelper.getRotatedShapes(VoxelHelper.rotate(Block.makeCuboidShape(-1, 0.01536686473017923, 14.000000000000002, 1, 4, 15.347759065022574), Direction.NORTH));
        final VoxelShape[] FRONT_LEFT_LEG = VoxelHelper.getRotatedShapes(VoxelHelper.rotate(Block.makeCuboidShape(-2, 0, -2, 1, 11, 14), Direction.NORTH));
        final VoxelShape[] FRONT_RIGHT_LEG = VoxelHelper.getRotatedShapes(VoxelHelper.rotate(Block.makeCuboidShape(15, 0, -2, 18, 11, 14), Direction.NORTH));
        final VoxelShape[] BACK_RIGHT_LEG = VoxelHelper.getRotatedShapes(VoxelHelper.rotate(Block.makeCuboidShape(15, 0.01536686473017923, 14.000000000000002, 17, 4, 15.347759065022574), Direction.NORTH));
        final VoxelShape[] LEFT_SUPPORT = VoxelHelper.getRotatedShapes(VoxelHelper.rotate(Block.makeCuboidShape(15, 0, -2, 18, 11, 14), Direction.NORTH));
        final VoxelShape[] RIGHT_SUPPORT = VoxelHelper.getRotatedShapes(VoxelHelper.rotate(Block.makeCuboidShape(-2, 0, -2, 1, 11, 14), Direction.NORTH));
    ...
    public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity playerEntity, Hand hand, BlockRayTraceResult result) {
        if (playerEntity.isCrouching()) {
            ...
            return SeatEntity.create(world, pos, 0.33, playerEntity);
        }
    }
